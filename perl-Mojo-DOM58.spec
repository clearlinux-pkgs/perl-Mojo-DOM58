...
Source0  : https://cpan.metacpan.org/authors/id/D/DB/DBOOK/Mojo-DOM58-3.000.tar.gz
...
%prep
%setup -q -n Mojo-DOM58-3.000
cd %{_builddir}/Mojo-DOM58-3.000
...
cp %{_builddir}/Mojo-DOM58-3.000/LICENSE %{buildroot}/usr/share/package-licenses/perl-Mojo-DOM58/3c84d6624185a8425697aa6be532533fba83d755
if test -f Makefile.PL; then
